...
public class BedrockPickaxeItem extends PickaxeItem {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        assert player != null;
        BlockPos voidPos = new BlockPos(player.blockPosition().getX(), level.dimensionType().minY(), player.blockPosition().getZ());
        boolean worldHasCeiling = level.dimensionType().hasCeiling();
        boolean worldIsFloating = level.getBlockState(voidPos) != Blocks.BEDROCK.defaultBlockState();
