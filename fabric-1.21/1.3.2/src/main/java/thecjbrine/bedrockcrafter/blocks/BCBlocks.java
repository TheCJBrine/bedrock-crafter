...
public class BCBlocks {
    ...
    public static final Block BEDROCK_GLASS = registerBlock("bedrock_glass", new TransparentBlock(FabricBlockSettings.copy(Blocks.GLASS)
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(BedrockCrafter.MODID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        Item item = Registry.register(Registries.ITEM, Identifier.of(BedrockCrafter.MODID, name), new BlockItem(block, new Item.Settings()));
        return item;
    }
