...
public class BCBlocks {
    ...
    public static final RegistryObject<Block> COMPACT_DEEPSLATE = BLOCKS.register("compact_deepslate", () -> new Block(BlockBehaviour.Properties.of(Material.STONE)
    .strength(4f, 7f).harvestTool(ToolType.PICKAXE).harvestLevel(0).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
    public static final RegistryObject<Block> D_COMPACT_DEEPSLATE = BLOCKS.register("double_compact_deepslate", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(5f, 8f).harvestTool(ToolType.PICKAXE).harvestLevel(0).requiresCorrectToolForDrops()
    ...
    public static final RegistryObject<Block> T_COMPACT_DEEPSLATE = BLOCKS.register("triple_compact_deepslate", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(6f, 9f).harvestTool(ToolType.PICKAXE).harvestLevel(0).requiresCorrectToolForDrops()
            .sound(SoundType.DEEPSLATE)));
    public static final RegistryObject<Block> Q_COMPACT_DEEPSLATE = BLOCKS.register("quadruple_compact_deepslate", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(7f, 10f).harvestTool(ToolType.PICKAXE).harvestLevel(0).requiresCorrectToolForDrops()
            .sound(SoundType.DEEPSLATE)));
    public static final RegistryObject<Block> COMPACT_OBSIDIAN = BLOCKS.register("compact_obsidian", () -> new Block(BlockBehaviour.Properties.of(Material.STONE)
    .strength(51f, 1201f).harvestTool(ToolType.PICKAXE).harvestLevel(3).requiresCorrectToolForDrops().sound(SoundType.STONE)));
    public static final RegistryObject<Block> D_COMPACT_OBSIDIAN = BLOCKS.register("double_compact_obsidian", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(52f, 1202f).harvestTool(ToolType.PICKAXE).harvestLevel(3).requiresCorrectToolForDrops()
    ...
    public static final RegistryObject<Block> T_COMPACT_OBSIDIAN = BLOCKS.register("triple_compact_obsidian", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(53f, 1203f).harvestTool(ToolType.PICKAXE).harvestLevel(3).requiresCorrectToolForDrops()
            .sound(SoundType.STONE)));
    public static final RegistryObject<Block> Q_COMPACT_OBSIDIAN = BLOCKS.register("quadruple_compact_obsidian", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(54f, 1204f).harvestTool(ToolType.PICKAXE).harvestLevel(3).requiresCorrectToolForDrops()
            .sound(SoundType.STONE)));
    ...
    public static final RegistryObject<StairBlock> P_BEDROCK_STAIRS = BLOCKS.register("polished_bedrock_stairs",
            () -> new StairBlock(Blocks.BEDROCK::defaultBlockState, BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
