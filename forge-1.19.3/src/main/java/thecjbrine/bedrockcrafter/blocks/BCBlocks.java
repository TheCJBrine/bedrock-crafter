...
public class BCBlocks {
    ...
    public static final RegistryObject<Block> COMPACT_DEEPSLATE = registerBlock("compact_deepslate", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(5f, 10f).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
    public static final RegistryObject<Block> COMPACT_OBSIDIAN = registerBlock("compact_obsidian", () -> new Block(BlockBehaviour.Properties
            .of(Material.STONE).strength(60f, 1400f).requiresCorrectToolForDrops().sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> BEDROCK_DOOR = registerBlock("bedrock_door", () -> new BCDoorBlock(BlockBehaviour.Properties
            .copy(Blocks.BEDROCK).noOcclusion(), BCSoundEvents.BLOCK_BEDROCK_DOOR_CLOSE.get(), BCSoundEvents.BLOCK_BEDROCK_DOOR_OPEN.get()));
    public static final RegistryObject<Block> BEDROCK_TRAPDOOR = registerBlock("bedrock_trapdoor", () -> new BCTrapdoorBlock(BlockBehaviour.Properties
            .copy(Blocks.BEDROCK).noOcclusion(), BCSoundEvents.BLOCK_BEDROCK_TRAPDOOR_CLOSE.get(), BCSoundEvents.BLOCK_BEDROCK_TRAPDOOR_OPEN.get()));
