...
public class BCTrapdoorBlock extends TrapDoorBlock {
    ...
    public BCTrapdoorBlock(Properties properties, SoundEvent closeSound, SoundEvent openSound) {
    ...
    protected void playSound(@Nullable Player player, Level level, BlockPos pos, boolean open) {
        level.playSound(player, pos, open ? this.openSound : this.closeSound, SoundSource.BLOCKS, 1F, level.getRandom().nextFloat() * 0.1F + 0.9F);
