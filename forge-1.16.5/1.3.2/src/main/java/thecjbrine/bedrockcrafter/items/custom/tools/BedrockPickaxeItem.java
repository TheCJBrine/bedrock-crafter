...
public class BedrockPickaxeItem extends PickaxeItem {
    ...
    public ActionResultType useOn(ItemUseContext context) {
        ...
        assert player != null;
        BlockPos voidPos = new BlockPos(player.blockPosition().getX(), worldBottom, player.blockPosition().getZ());
        boolean worldHasCeiling = world.dimensionType().hasCeiling();
        boolean worldIsFloating = world.getBlockState(voidPos) != Blocks.BEDROCK.defaultBlockState();
